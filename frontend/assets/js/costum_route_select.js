...
export const CONTACT_NAME = "Apple Adven";
export const contactNameEl = document.getElementById("contactDisplayName");
export const ta = document.querySelector('#mailBody');